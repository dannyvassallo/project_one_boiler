...
void 0 === jQuery.migrateMute && (jQuery.migrateMute = !0), (function (e) {
  ...
  const i = e.fn.init; const s = e.isNumeric; const u = e.find; const c = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/; const
    l = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/g;
  ...
  const f = e.fn.removeAttr; const y = e.fn.toggleClass; const
    m = /\S+/g;
  e.fn.removeAttr = function (t) {
    const n = this;
    return e.each(t.match(m), (t, a) => {
  ...
  let h = !1;
  e.swap && e.each(['height', 'width', 'reliableMarginRight'], (t, r) => {
  ...
  const v = e.Tween.prototype.run; const
    j = function (e) {
      return e;
    };
  ...
  const Q = e.fn.load; const b = e.event.add; const
    w = e.event.fix;
  e.event.props = [], e.event.fixHooks = {}, n(e.event.props, 'concat', e.event.props.concat, 'jQuery.event.props.concat() is deprecated and removed'),
  e.event.fix = function (t) {
    let n; const a = t.type; const o = this.fixHooks[a]; let
      i = e.event.props;
  ...
  }), e.each('blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu'.split(' '), (t, n) => {
    e.fn[n] = function (e, t) {
  ...
  return e.Deferred = function (t) {
    ...
    return n.pipe = a.pipe = function () {
      let t = arguments;
      return r('deferred.pipe() is deprecated'), e.Deferred((r) => {
        e.each(q, (o, i) => {
