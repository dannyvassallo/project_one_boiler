...
app.get('/profile', (req, res) => res.sendFile(html_dir + 'profile.html', { root: __dirname }))
app.get('/useraccount', (req, res) => res.sendFile(html_dir + 'useraccount.html', { root: __dirname }))
